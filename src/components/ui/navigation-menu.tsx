...
// Note that this was edited from the original shadcn to set
// data-[status=active]: instead of data-active: for Tanstack Router compatibility.
// We also made the active bg-muted/75 instead of bg-muted/50 to make it more visible.
...
function NavigationMenuLink({ className, ...props }: NavigationMenuPrimitive.Link.Props) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md data-[status=active]:bg-muted/75 data-[status=active]:hover:bg-muted data-[status=active]:focus:bg-muted [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
