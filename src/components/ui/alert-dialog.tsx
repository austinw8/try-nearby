...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "pt-2 flex flex-col-reverse gap-2 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-center",
        className,
      )}
      {...props}
    />
